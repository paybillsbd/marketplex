              ...
              @foreach($paginated_products as $singleProduct)
                  <div class="col-sm-3 col-lg-3 col-md-3">
                      <div class="thumbnail">
                          ...
                          <a href="javascript:void(0);" class="btn btn-success add-to-cart" id="add_to_cart{{\MarketPlex\ShoppingCart::existInArray($cart->items,$singleProduct->id)? "-inactive":"" }}" data-fingerprint="{{ $cart->fingerprint }}" data-pid="{{ $singleProduct->id }}">{{ \MarketPlex\ShoppingCart::existInArray($cart->items,$singleProduct->id)? "Added": "Add to Cart"}}</a>
                      </div>
                  </div>
              @endforeach
