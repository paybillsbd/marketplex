...
<?php $__env->startSection('title-module-name', 'Products'); ?>

<?php $__env->startSection('header-style'); ?>
    <link href="<?php echo e(URL::asset('/vendor/inzaana/css/select2.min.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(URL::asset('/vendor/inzaana/css/dragdrop.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(URL::asset('/vendor/inzaana/css/newStyle.css')); ?>" rel="stylesheet" type="text/css">
...
<?php $__env->startSection('modals'); ?>
    <?php echo $__env->make('includes.modals.modal-product-add', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="box box-info">
        <div class="box-body">
            <div class="row padTB">
                <!--form-->
                <form action="<?php echo e(route('user::products.search')); ?>" method="GET">
                    <div class="col-lg-6 col-lg-offset-3">
                        <div class="box box-widget">
                            <div class="box-header with-border">
                                <h4 class="boxed-header">Find it on <?php echo e(config('app.vendor')); ?></h4>
                            </div>
                            <div class="box-body">
                            ...
                            <div class="box-footer box-comments<?php echo e($productsCount == 0 ? '' : ' hidden'); ?>">
                                <div class="box-comment">
                                    <div class="col-lg-6">
                                        <h4 class="C-header">If it is not in <?php echo e(config('app.vendor')); ?>'s catalog:</h4>
                                    </div>
                ...
                <div class="col-lg-6 col-lg-offset-3 boxPadTop">
                    <div id="sell_yours_search" class="box box-down box-info">
                                ...
                                <?php if(isset($products)): ?>
                                    ...
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if($product->marketProduct()): ?>
                                            <tr id="product_<?php echo e($product->id); ?>">
                                                <!-- <td id="child"><a href="">001</a> </td> -->
                                                <td style="vertical-align: middle"><input type="checkbox" name="check_box" value="<?php echo e($product->id); ?>" id=""></td>
                                                <td id="child"><a href=""><?php echo e($product->title); ?></a></td>
                                                <td id="child"><a href=""><?php echo e($product->categoryName()); ?></a></td>
                                                ...
                                                <td id="child"><a href=""><?php echo e($product->available_quantity); ?></a></td> <!-- Available quantity-->
                                                <td id="child"><a href=""><?php echo e($product->return_time_limit); ?></a></td> <!-- Time limit for return-->
                                                <td id="child"><?php echo $__env->make('includes.approval-label', [ 'status' => $product->status, 'labelText' => $product->getStatus() ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></td>
                                                <td class="text-center" id="child">
                                                    <form id="product-modification-form" class="form-horizontal" method="POST" >
                                                        <?php echo csrf_field(); ?>


                                                        <?php echo $__env->make('includes.single-product-actions', compact('product'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                </form>
                                            </td>
                                        </tr>
        ...
        <?php echo $__env->renderEach('includes.product-delete-confirm-modal', $products, 'product'); ?>

        <div id="modal_container"></div>
        <div id="alert_modal_container"></div>

        <?php $__env->stopSection(); ?>

        <?php $__env->startSection('footer-scripts'); ?>

            <script src="<?php echo e(asset('/vendor/inzaana/js/select2.full.min.js')); ?>" type="text/javascript"></script>
            <script src="//cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.3.0/js/bootstrap-datepicker.min.js"></script>
            <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
            <script src="<?php echo e(asset('/vendor/inzaana/js/product/product.js')); ?>" type="text/javascript"></script>
            <script>
            ...
            <script type="text/javascript">
                ...
                function productFormEvents()
                {
                    $('#product-form-open-button').click(function(){
                        ...
                        $('#product-create-form').attr("action", "<?php echo e(route('user::products.create')); ?>");
